...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        public static List<string> RunProblem1(List<string> words)
        {
            ...
            newList  = words.Where(m => m.Contains("th")).ToList();
        ...
        public static List<string> RunProblem2(List<string> names)
        {
            //code
            List<string> newList;
            newList = names.Select(m => m).Distinct().ToList();
        ...
        public static Customer RunProblem3(List<Customer> customers)
        {
            ...
            newList = customers.Where(m => m.FirstName == "Mike").ToList();
        ...
        public static Customer RunProblem4(List<Customer> customers)
        {
            ...
            newList = customers.Where(m => m.Id == 3).ToList();
            newList[0].FirstName = "Dave";
            newList[0].LastName = "Mustaine";
            //return
            Console.WriteLine($"{newList[0].Id} {newList[0].FirstName} {newList[0].LastName}");
            Console.WriteLine("");
            return newList[0];
        }
        #endregion
